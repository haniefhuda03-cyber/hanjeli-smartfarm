# CLAUDE.md — Hanjeli SmartFarm AI Agent System
...
5. **Konsistensi dengan design system** ("Organic Vitality" Neumorphic) adalah prioritas visual, bisa menggunakan desain neumorphism, glassmorphism, soft ui, frost ui (soft glass), dan claymorphism style menyesuaikan dengan desain yang sudah ada di project ini dan selalu menjaga konsistensi desain.
